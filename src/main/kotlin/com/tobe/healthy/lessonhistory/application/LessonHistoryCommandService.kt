    ...
    fun registerLessonHistoryComment(
        ...
        if (member.memberId != lessonHistory.trainer!!.id) {
            sendNotification(
                ...
                clickUrl = "https://main.to-be-healthy.shop/trainer/manage/${lessonHistory.student!!.id}/log/${lessonHistory.id}",
            ...
            when (parentComment.writer!!.memberType) {
                STUDENT -> {
                    sendNotification(
                        ...
                        clickUrl = "https://main.to-be-healthy.shop/student/log/${lessonHistory.id}",
                        studentId = lessonHistory.student!!.id,
                        studentName = lessonHistory.student!!.name
                    )
                }
