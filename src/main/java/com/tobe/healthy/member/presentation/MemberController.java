...
public class MemberController {
	...
	public ResponseHandler<Tokens> getNaverAccessToken(@Parameter(description = "소셜에서 발급한 code") @RequestParam String code, @Parameter(description = "소셜에서 발급한 state") @RequestParam String state) {
		return ResponseHandler.<Tokens>builder()
