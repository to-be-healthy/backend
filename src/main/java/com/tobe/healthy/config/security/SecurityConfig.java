...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        return request -> {
            ...
            config.setAllowedOriginPatterns(List.of("http://localhost:3000", "https://api.to-be-healthy.site", "https://to-be-healthy.site", "https://www.to-be-healthy.site", "https://dev-api.to-be-healthy.site"));
