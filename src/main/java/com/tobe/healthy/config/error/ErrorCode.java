...
public enum ErrorCode {
	...
	MEMBER_NAME_LENGTH_NOT_VALID(BAD_REQUEST, "C_033", "이름은 최소 2자 이상 입력해 주세요."),
	MEMBER_NAME_NOT_VALID(BAD_REQUEST, "C_034", "이름은 한글 또는 영어만 입력할 수 있습니다."),
	CONFIRM_PASSWORD_NOT_MATCHED(BAD_REQUEST, "C_035", "비밀번호가 일치하지 않습니다."),
	USERID_POLICY_VIOLATION(BAD_REQUEST, "C_036", "아이디에 한글을 포함할 수 없습니다."),
	PASSWORD_POLICY_VIOLATION(BAD_REQUEST, "C_037", "영문+숫자 조합 8자리 이상을 입력해 주세요."),
	GYM_NOT_FOUND(NOT_FOUND, "C_038", "등록된 헬스장이 없습니다."),
	GYM_DUPLICATION(BAD_REQUEST, "C_039", "중복된 헬스장이 존재합니다."),
	JOIN_CODE_NOT_VALID(BAD_REQUEST, "C_040", "인증코드가 일치하지 않습니다. 다시 확인해 주세요."),
	MEMBER_ID_NOT_VALID(BAD_REQUEST, "C_041", "영문 4자리 이상 입력해 주세요."),
	TRAINER_NOT_FOUND(NOT_FOUND, "C_042", "트레이너가 존재하지 않습니다."),
	LESSON_HISTORY_NOT_FOUND(NOT_FOUND, "C_043", "수업 일지가 존재하지 않습니다."),
	LESSON_HISTORY_COMMENT_NOT_FOUND(NOT_FOUND, "C_044", "수업 일지 댓글이 존재하지 않습니다."),
	EXCEED_MAXIMUM_NUMBER_OF_FILES(BAD_REQUEST, "C_045", "파일 업로드는 최대 3개까지 가능합니다."),
	LUNCH_TIME_INVALID(BAD_REQUEST, "C_046", "시작 점심시간이 종료 점심시간과 같거나 빠를 수 없습니다."),
	SCHEDULE_LESS_THAN_31_DAYS(BAD_REQUEST, "C_047", "일정 등록은 31일을 넘을 수 없습니다."),
	START_DATE_AFTER_END_DATE(BAD_REQUEST, "C_048", "수업 시작일은 종료일보다 빨라야 합니다."),
	SCHEDULE_ALREADY_EXISTS(BAD_REQUEST, "C_049", "이미 등록된 일정이 존재합니다."),
	RESERVATION_NOT_VALID(BAD_REQUEST, "C_050", "예약 가능한 시간이 아닙니다."),
	RESERVATION_CANCEL_NOT_VALID(BAD_REQUEST, "C_051", "취소 가능한 시간이 아닙니다."),
	UNCHANGED_GYM_ID(BAD_REQUEST, "C_052", "변경하려는 헬스장은 이전과 동일한 헬스장입니다."),
	TRAINER_SCHEDULE_NOT_FOUND(BAD_REQUEST, "C_053", "미리 스케줄을 등록 후 사용해 주세요."),
	INVALID_LESSON_TIME_DESCRIPTION(BAD_REQUEST, "C_054", "유효하지 않은 수업 시간입니다."),
	SEARCH_LESS_THAN_31_DAYS(BAD_REQUEST, "C_055", "일정 조회는 31일을 넘을 수 없습니다."),
	START_TIME_AFTER_END_TIME(BAD_REQUEST, "C_056", "수업 시작 시간은 종료 시간보다 빨라야 합니다."),
