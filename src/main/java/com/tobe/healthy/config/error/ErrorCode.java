...
public enum ErrorCode {
	...
	NOT_SCHEDULE_WAITING(BAD_REQUEST, "C_014", "대기할 수 없는 일정입니다."),
	...
	LESSON_HISTORY_NOT_FOUND(NOT_FOUND, "C_029", "수업 일지가 존재하지 않습니다."),
	...
	LUNCH_TIME_INVALID(BAD_REQUEST, "C_032", "점심시간은 같거나 시작시간보다 빠를 수 없습니다."),
	...
	RESERVATION_NOT_VALID(BAD_REQUEST, "C_036", "예약 가능한 시간이 아닙니다."),
