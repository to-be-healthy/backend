...
public interface LessonHistoryRepositoryCustom {
    ...
    List<LessonHistory> findAllLessonHistory(RetrieveLessonHistoryByDateCond request, Long memberId, MemberType memberType);
    LessonHistory findOneLessonHistory(Long lessonHistoryId, Long memberId, MemberType memberType);
    List<LessonHistory> findAllLessonHistoryByMemberId(Long studentId, RetrieveLessonHistoryByDateCond request, Long trainerId);
    RetrieveLessonHistoryByDateCondResult findTop1LessonHistoryByMemberId(Long studentId);
    Page<LessonHistory> findAllMyLessonHistory(RetrieveLessonHistoryByDateCond request, Pageable pageable, CustomMemberDetails member);
