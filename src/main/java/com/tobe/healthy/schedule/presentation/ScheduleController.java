...
public class ScheduleController {
	...
	@Operation(summary = "수업 신청한다.", responses = {
		@ApiResponse(responseCode = "200", description = "수업 신청 완료")
	})
	@PostMapping("/{scheduleId}")
	public ResponseHandler<Boolean> reserveSchedule(@Parameter(description = "일정 아이디") @PathVariable Long scheduleId, @AuthenticationPrincipal CustomMemberDetails customMemberDetails) {
		return ResponseHandler.<Boolean>builder()
			.statusCode(HttpStatus.OK)
